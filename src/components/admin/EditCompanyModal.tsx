...
export default function EditCompanyModal({ company }: { company: Company }) {
  ...
  const [mode, setMode] = useState(company.mode_of_joining);
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4 text-slate-700">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    required name="term_of_contract" type="number" min={1} defaultValue={company.term_of_contract}
                ...
                <div>
                  ...
                  <input
                    required name="agreement_start_date" type="date" defaultValue={company.agreement_start_date}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input defaultValue={company.room_allocated || ''} name="room_allocated" type="text" placeholder="e.g. Room 204" className="w-full border border-slate-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 outline-none" />
                </div>
              </div>
              ...
              {mode === 'offline' && (
                <div>
                  ...
                  <input
                    required={mode === 'offline'} name="area_occupied" type="number" min={0} step="any" defaultValue={company.area_occupied}
